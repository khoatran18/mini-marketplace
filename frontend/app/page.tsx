        ...
        <div className="grid gap-4 md:grid-cols-3">
          <article className="card">
            ...
            <p className="text-sm text-slate-600">
              ...
              <strong> seller_employee</strong> theo OpenAPI của API Gateway. Phiên đăng nhập được lưu trữ an toàn để sử
              dụng cho các yêu cầu cần xác thực.
            </p>
          </article>
          <article className="card">
          ...
          <article className="card">
            ...
            <p className="text-sm text-slate-600">
              Thêm sản phẩm vào giỏ, chỉnh số lượng theo nhu cầu rồi checkout để gọi API tạo đơn hàng chỉ với một cú
              nhấp chuột.
            </p>
          </article>
        </div>
