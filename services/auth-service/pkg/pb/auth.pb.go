...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\fauth_service\"e\n" +
	"\aAccount\x12\x0e\n" +
	...
	"\vAuthService\x12@\n" +
	"\x05Login\x12\x1a.auth_service.LoginRequest\x1a\x1b.auth_service.LoginResponse\x12I\n" +
	"\bRegister\x12\x1d.auth_service.RegisterRequest\x1a\x1e.auth_service.RegisterResponseB\x15Z\x13auth-service/pkg/pbb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	(*Account)(nil),          // 0: auth_service.Account
...
var file_auth_proto_depIdxs = []int32{
	...
	3, // 2: auth_service.AuthService.Login:output_type -> auth_service.LoginResponse
	4, // 3: auth_service.AuthService.Register:output_type -> auth_service.RegisterResponse
